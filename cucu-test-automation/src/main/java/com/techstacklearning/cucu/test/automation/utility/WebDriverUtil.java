package com.techstacklearning.cucu.test.automation.utility;

import com.techstacklearning.cucu.test.automation.exceptions.UnImplementedCallException;
import com.techstacklearning.cucu.test.automation.exceptions.UnmatchedCaseException;
...
public class WebDriverUtil {
    ...
    private void startBrowser(String browserType) throws UnmatchedCaseException, UnImplementedCallException {
        if (browserType.equalsIgnoreCase("chrome")) {
            ...
            throw new UnmatchedCaseException(String.format("%s is invalid/unimplemented browser case.", browserType));
        }
